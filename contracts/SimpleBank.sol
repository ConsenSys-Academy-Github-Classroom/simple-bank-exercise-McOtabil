...
contract SimpleBank {
    ...
    event LogDepositMade(address accountAddress , uint amount); // added deposit address and deposit amount
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require(withdrawAmount <= balances[msg.sender] , " withdrawal should be less than balance");
